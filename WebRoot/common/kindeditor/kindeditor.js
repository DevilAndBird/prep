...
KE.plugin['image'] = {
	...
	insert : function(id, url, title, width, height, border, align) {
		/*var ym=document.location.href;
		var str=ym.split("/");
		//var ljee=str[0]+"//"+str[2];
		//var lj=str[0]+"//"+"www.4006695539.com/PLB";
		var lj=str[0]+"//"+"manager.csairholiday.com/attached";//这个是新服务器的
		var strr=url.split("/");
		var urls="";
		for(var i=2;i<strr.length;i++){
			urls+="/"+strr[i];
		}
		var html = '<img src="' + url + '" kesrc="'+lj+ urls + '" ';*/
		var html = '<img src="' + 'http://manager.csairholiday.com'+url + '" kesrc="' + 'http://manager.csairholiday.com'+url + '" ';
